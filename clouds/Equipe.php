...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "controle")) {
  ...
  $insertSQL = sprintf("INSERT INTO equipe (titulo_equipe, desc_equipe, tags_equipe, texto_equipe, status_equipe) VALUES (%s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $conexao) or die(mysql_error());
	...
	<SCRIPT language="JavaScript">
		...
		location.href="Equipe.php?cod=1";
	</script>
	<?
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "controle")) {
  ...
  $updateSQL = sprintf("UPDATE equipe SET titulo_equipe=%s, desc_equipe=%s, tags_equipe=%s, texto_equipe=%s, status_equipe=%s WHERE id_equipe=%s",
					   GetSQLValueString($_POST['titulo_equipe'],"text"),
					   GetSQLValueString($_POST['desc_equipe'],"text"),
					   GetSQLValueString($_POST['tags_equipe'],"text"),
					   GetSQLValueString($_POST['texto_equipe'],"text"),
  ...
  <div class="page-content">
    ...
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li><a href="Equipe.php?cod=1">EQUIPE</a></li>
