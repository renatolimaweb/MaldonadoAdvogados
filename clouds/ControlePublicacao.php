...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "controle")) {
    ...
    move_uploaded_file($_FILES['imagem_publicacao']['tmp_name'],$salva ); // Este comando move o arquivo do diretório temporário para o caminho especificado acima
  ...
  <div class="page-content">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3>PUBLICAÇÕES <small>CONTROLE DE DADOS DAS PUBLICAÇÕES</small></h3>
      </div>
    </div>
    <!-- /page header -->
    <!-- Breadcrumbs line -->
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li><a href="ConsultaPublicacao.php">PUBLICAÇÕES</a></li>
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
           <label class="col-sm-2 control-label">Categoria: </label>
            <div class="col-sm-5">
             <select id="id_categoria_publicacao" name="id_categoria_publicacao" data-placeholder="Selecione a Categoria da Notícia" class="select-search" tabindex="2" required>
             <option value=""></option>
             <?php
                    do {  
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea id="desc_publicacao" name="desc_publicacao" rows="5" cols="5" class="elastic form-control" placeholder="Digite a Descrição" required><?=$row_busca_dados["desc_publicacao"];?></textarea>
            </div>
          </div>
          <div class="form-group">
