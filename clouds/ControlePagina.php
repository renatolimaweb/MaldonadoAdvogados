...
<title>RENAN MALDONADO | PÁGINAS | CLOUDS | SISTEMA GERENCIADOR DE CONTEÚDO</title>
  ...
  <div class="page-content">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3>PÁGINAS <small>FORMULÁRIO DE CONTROLE DE DADOS</small></h3>
      </div>
    </div>
    <!-- /page header -->
    <!-- Breadcrumbs line -->
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li><a href="ConsultaPagina.php">PÁGINAS</a></li>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea id="desc_pagina" name="desc_pagina" rows="5" cols="5" class="elastic form-control" placeholder="Digite a Descrição"><?=$row_busca_dados["desc_pagina"];?></textarea>
            </div>
          </div>
          <div class="form-group">
